...
motor back_arm = motor(PORT13, ratio36_1, true);
motor front_mogo = motor(PORT3, ratio36_1, true);
motor four_bar = motor(PORT2, ratio36_1, false);
motor four_bar2 = motor(PORT7, ratio36_1, true);
...
limit front_mogo_limit = limit(Brain.ThreeWirePort.D);
